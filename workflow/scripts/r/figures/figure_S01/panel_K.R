plot_figure_s01_k <- function(output_pdf, output_svg) {
  ...
  ont_bulk_tx_heatmaps <- c("results/format/run_bambu_lr/1_15000000.0/ont/gencode/transcript_counts_formatted.tsv", "results/format/run_isoquant_lr/1_15000000.0/ont/gencode/transcript_counts_formatted.tsv", "results/format/run_isosceles_lr/1_15000000.0/ont/gencode/transcript_counts_formatted.tsv", "results/format/run_kallisto_long_lr/1_15000000.0/ont/gencode/transcript_counts_formatted.tsv", "results/format/run_miniquant_lr/1_15000000.0/ont/gencode/transcript_counts_formatted.tsv", "results/format/run_oarfish_lr/1_15000000.0/ont/gencode/transcript_counts_formatted.tsv")
  p_hm_ont_bulk <- get_heatmap_row(ont_bulk_tx_heatmaps, names_bulk_heatmap)

  panel_plot <- p_hm_ont_bulk
...
if (exists("snakemake")) {
  ...
  output_pdf <- "results/figure_S01/panel_K.pdf"
  output_svg <- "results/figure_S01/panel_K.svg"
}

plot_figure_s01_k(output_pdf = output_pdf, output_svg = output_svg)
