plot_figure_s01_l <- function(output_pdf, output_svg) {
  ...
  pb_sc_tx_heatmaps <- c("results/format_quantify_subsampled/gencode/pb/1_60000000.0/bambu/pseudobulk/transcript_counts_formatted.tsv", "results/format_quantify_subsampled/gencode/pb/1_60000000.0/isosceles/pseudobulk/transcript_counts_formatted.tsv", "results/format_quantify_subsampled/gencode/pb/1_60000000.0/kallisto/pseudobulk/transcript_counts_formatted.tsv", "results/format_quantify_subsampled/gencode/pb/1_60000000.0/oarfish/pseudobulk/transcript_counts_formatted.tsv")
  p_hm_pb_sc <- get_heatmap_row(pb_sc_tx_heatmaps, names_sc_heatmap)

  panel_plot <- p_hm_pb_sc
...
if (exists("snakemake")) {
  ...
  output_pdf <- "results/figure_S01/panel_L.pdf"
  output_svg <- "results/figure_S01/panel_L.svg"
}

plot_figure_s01_l(output_pdf = output_pdf, output_svg = output_svg)
